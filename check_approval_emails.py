...
# Connect to database
db_url = os.getenv('DATABASE_URL') or "postgresql://postgres:YourStr0ng!Pass@localhost:5433/odoo_procurement_demo"
print(f"Connecting to: {db_url.replace('YourStr0ng!Pass', '***')}")
